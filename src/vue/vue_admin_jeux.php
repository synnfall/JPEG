...
function html_form_update_jeu($jeu) {
    return "<form method='POST' action='admin_jeux.php'>
        <label>Nom</label><input type='text' name='nom' value='{$jeu['nom']}'><br>
        <label>Likes</label><input type='number' name='likes' value='{$jeu['likes']}'><br>
        <label>Description</label><textarea name='description'>{$jeu['description']}</textarea><br>
        <input type='hidden' name='JeuID' value='{$jeu['JeuID']}'>
